...
@Schema(description = """
        ...
        Messages are composed of one or more "ContentBlocks". In general, although not mandatory, only "assistant"-role messages have more than
        one "ContentBlock" to include/express different steps the model has taken, including, thinking blocks, tool execution requests and
